...
"""
@alexandru zubarev:
Created class TestData with defined setUp method.
Tests below with commented cose are testing the packing of BGP NLRI data:
1. IPv4 prefix (network address for that subnet) and Length (network mask).
2. IPv6 properties and network representation.
Usually, a set of NLRI announcements are sent in each BGP Update message.
"""
